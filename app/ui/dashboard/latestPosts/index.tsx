...
const LatestPosts = ({ posts }: { posts: PostType[] }) => {
  return (
    <div className='w-full max-w-md p-3 bg-white border border-neutral-200 rounded-xs rounded-br-2xl shadow-sm sm:p-3 dark:bg-neutral-900 dark:border-neutral-800'>
