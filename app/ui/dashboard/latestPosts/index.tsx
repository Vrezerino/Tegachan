...
const LatestPosts = ({ posts }: { posts: PostType[] }) => {
  return (
    <div className='w-full mx-auto max-w-[700px] p-3 bg-white border border-neutral-200 rounded-xs rounded-br-2xl shadow-sm sm:p-3 mb-3 md-big:m-0 dark:bg-neutral-900 dark:border-neutral-800'>
