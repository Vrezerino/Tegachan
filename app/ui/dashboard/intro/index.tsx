...
const Intro = () => {
  return (
    <div className='mt-0 mb-3 mx-auto w-full max-w-md p-2 bg-white border border-neutral-200 rounded-xs rounded-br-2xl shadow-sm sm:p-3 dark:bg-neutral-900 dark:border-neutral-800'>
