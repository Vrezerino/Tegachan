...
const Page = () => {
  return (
    <div className='mt-0 mb-16 mx-auto w-full max-w-md p-2 bg-white border border-gray-200 rounded-xs rounded-br-2xl shadow-sm sm:p-3 text-gray-900 dark:text-white dark:bg-neutral-900 dark:border-gray-700'>
      ...
      <h3 className='text-center text-xl font-bold leading-none mt-12 mb-6 dark:header-darkmode'>Site Information</h3>
