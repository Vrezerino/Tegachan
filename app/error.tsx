  ...
  return (
    <div className='flex flex-col bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-neutral-900'>
      ...
      <div className='flex flex-col justify-between p-4 leading-normal'>
        ...
        <Link
          href={'/'}
          className='text-neutral-900 rounded-md p-3 border border-orange-200/50 dark:border-neutral-500/70 bg-sky-100/40 dark:bg-neutral-700 text-sm font-medium dark:text-neutral-300 hover:bg-blue-200/60 md:flex-none md:justify-start md:p-2 md:px-3'>
          Return to index
        </Link>
      </div>
    </div>
